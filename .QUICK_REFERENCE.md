...
BROKER=alpaca TRADING_ENV=live python -m trading_bot.main
```
...
| Problem | Solution |
|---------|----------|
| Connection refused | Start PostgreSQL: `docker start trading-bot-db` |
| Table doesn't exist | Initialize: `python -m trading_bot.database.init` |
...
psql -U postgres -d trading_bot -c "DELETE FROM trades;"
