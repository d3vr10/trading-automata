...
class SigmaSeriesFastStrategy(BaseStrategy):
    ...
    def on_bar(self, bar: Bar) -> Optional[Signal]:
        ...
        try:
            ...
            if (
                price_above_vwap  # Currently above VWAP
                and not prev_above_vwap  # Was below (crossover up)
            ...
            if (
                not price_above_vwap  # Currently below VWAP
                and prev_above_vwap  # Was above (crossover down)
